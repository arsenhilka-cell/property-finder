...
export const cities: CityConfig[] = [
  ...
  city({ id: "kamianske", labelRu: "Каменское", labelUk: "Кам'янське", aliases: ["Кам’янське", "Камянское", "Днепродзержинск", "Дніпродзержинськ", "Kamianske", "Kamenskoe", "Dneprodzerzhinsk"], regionRu: "Днепропетровская область", regionUk: "Дніпропетровська область", priority: 20, olx: { slug: "kamenskoe" } }),
  ...
  city({ id: "kremenchuk", labelRu: "Кременчуг", labelUk: "Кременчук", aliases: ["Кременчук", "Kremenchuk"], regionRu: "Полтавская область", regionUk: "Полтавська область", priority: 20, olx: { slug: "kremenchug" }, dimria: { slug: "kremenchug" } }),
