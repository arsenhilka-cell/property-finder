...
export const cities: CityConfig[] = [
  ...
  city({ id: "zhytomyr", labelRu: "Житомир", labelUk: "Житомир", aliases: ["Zhytomyr", "Zhitomir"] }),
  city({ id: "kryvyi-rih", labelRu: "Кривой Рог", labelUk: "Кривий Ріг", aliases: ["Кривий Ріг", "Kryvyi Rih", "Krivoy Rog"] }),
  city({ id: "mykolaiv", labelRu: "Николаев", labelUk: "Миколаїв", aliases: ["Миколаїв", "Mykolaiv", "Nikolaev"] }),
  city({ id: "kherson", labelRu: "Херсон", labelUk: "Херсон", aliases: ["Kherson"] }),
  city({ id: "chernihiv", labelRu: "Чернигов", labelUk: "Чернігів", aliases: ["Чернігів", "Chernihiv", "Chernigov"] }),
  city({ id: "sumy", labelRu: "Сумы", labelUk: "Суми", aliases: ["Суми", "Sumy"] }),
  city({ id: "chernivtsi", labelRu: "Черновцы", labelUk: "Чернівці", aliases: ["Чернівці", "Chernivtsi", "Chernovtsy"] }),
  city({ id: "uzhhorod", labelRu: "Ужгород", labelUk: "Ужгород", aliases: ["Uzhhorod", "Uzhgorod"] }),
  city({ id: "rivne", labelRu: "Ровно", labelUk: "Рівне", aliases: ["Рівне", "Rivne", "Rovno"] }),
  city({ id: "lutsk", labelRu: "Луцк", labelUk: "Луцьк", aliases: ["Луцьк", "Lutsk"] }),
  city({ id: "ivano-frankivsk", labelRu: "Ивано-Франковск", labelUk: "Івано-Франківськ", aliases: ["Івано-Франківськ", "Ivano-Frankivsk", "Ivano Frankivsk"] }),
  city({ id: "ternopil", labelRu: "Тернополь", labelUk: "Тернопіль", aliases: ["Тернопіль", "Ternopil", "Ternopol"] }),
  city({ id: "kropyvnytskyi", labelRu: "Кропивницкий", labelUk: "Кропивницький", aliases: ["Кропивницький", "Кировоград", "Kropyvnytskyi", "Kirovograd"] }),
  ...
  city({ id: "khmelnytskyi", labelRu: "Хмельницкий", labelUk: "Хмельницький", aliases: ["Хмельницький", "Khmelnytskyi", "Khmelnytsky"], regionRu: "Хмельницкая область", regionUk: "Хмельницька область", priority: 10 }),
